...
const siteName = 'Mercedes-Benz of Fairfield'
const description = 'Visit Mercedes-Benz of Fairfield for new and certified pre-owned Mercedes-Benz vehicles, expert service, and financing in Fairfield, CA.'
...
export const metadata: Metadata = {
  ...
  description,
  keywords: [
    'Mercedes-Benz dealer Fairfield',
    'Mercedes-Benz Fairfield CA',
    'new Mercedes-Benz for sale',
    'certified pre-owned Mercedes',
    'Mercedes-Benz service Fairfield',
    'Mercedes-Benz parts Fairfield',
    'luxury car dealer Fairfield',
  ...
  other: {
    'geo.region': 'US-CA',
    'geo.placename': 'Fairfield',
    'geo.position': '38.2494;-122.0400',
    'ICBM': '38.2494, -122.0400'
  }
}
